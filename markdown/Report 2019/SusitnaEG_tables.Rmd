...
Table: Table 1.- Aerial survey observability and lognormal standard deviation with 95% confidence interval for each surveyed spawning area tributary in the Susitna River drainage, calendar years 1979--2017.
```{r}
table_airerror(post)
``` 

Table: Table 2.- State-space model parameter estimates for Susitna River Chinook salmon by stock group, calendar years 1979--2017. 
```{r}
table_params(post)
```
