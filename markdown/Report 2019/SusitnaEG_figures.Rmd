...
```{r, fig.width = 7, fig.height = 7, fig.cap = "Figure 4.- Plausible spawner-recruit relationships for the Deshka River Chinook salmon stock group as derived from an age-structured state-space model fitted to abundance, harvest, and age data for 1979--2014."}
...
```{r fig.width = 7, fig.height = 5, fig.cap = "Figure 6.- Expected sustained yield (ESY) plots for the Deshka River Chinook salmon stock group. ESY median (solid black line) and 50% interval (grey-shaded area around the line) assume average productivity for brood years 1979--2014."}
...
```{r, fig.width = 7, fig.height = 7, fig.cap = "Figure 9.- Plausible spawner-recruit relationships for the Eastside Susitna Chinook salmon stock group as derived from an age-structured state-space model fitted to abundance, harvest, and age data for 1979--2014."}
horse[[2]]
```
...
```{r fig.width = 7, fig.height = 5, fig.cap = "Figure 11.- Expected sustained yield (ESY) plots for the Eastside Susitna River Chinook salmon stock group. ESY median (solid black line) and 50% interval (grey-shaded area around the line) assume average productivity for brood years 1973--2014."}
ey[[2]]
```
...
```{r, fig.width = 7, fig.height = 7, fig.cap = "Figure 13.- Plausible spawner-recruit relationships for the Talkeetna River Chinook salmon stock group as derived from an age-structured state-space model fitted to abundance, harvest, and age data for 1979--2014."}
horse[[3]]
```
...
```{r fig.width = 7, fig.height = 5, fig.cap = "Figure 15.- Expected sustained yield (ESY) plots for the Talkeetna River Chinook salmon stock group. ESY median (solid black line) and 50% interval (grey-shaded area around the line) assume average productivity for brood years 1979--2014."}
ey[[3]]
``` 
...
```{r, fig.width = 7, fig.height = 7, fig.cap = "Figure 17.- Plausible spawner-recruit relationships for the Yentna River Chinook salmon stock group as derived from an age-structured state-space model fitted to abundance, harvest, and age data for 1979--2014."}
horse[[4]]
```
...
```{r fig.width = 7, fig.height = 5, fig.cap = "Figure 19.- Expected sustained yield (ESY) plots for the Yentna River Chinook salmon stock group. ESY median (solid black line) and 50% interval (grey-shaded area around the line) assume average productivity for brood years 1979-2014."}
ey[[4]]
```
