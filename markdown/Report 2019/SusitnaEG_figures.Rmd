...
![Figure 1.- Susitna River Chinook salmon management areas. ](management_units.png)
...
```{r fig.width = 7, fig.height = 5, fig.cap = "Figure 6.- Expected sustained yield plots for Deshka River Chinook salmon. ESY median (solid black line), and 50% interval (grey-shaded area around the line) assume average productivity for brood years 1979-2014. Pink shaded areas bracket the proposed goal range; grey and black marks along the x-axis show comparable lower and upper bounds for other Alaskan Chinook salmon stocks scaled by $S_{MSY}$ ratios (see Methods)."}
...
```{r, fig.width = 7, fig.height = 9, fig.cap = "Figure 22.- Point estimates (posterior medians; solid lines) and 95% credibility intervals (shaded areas) of Ricker productivity residuals from a state-space model by stock group, 1979-2017."}
